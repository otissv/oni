...
layout(location = 5) in vec4 radii;
layout(location = 6) in vec2 params;
layout(location = 7) in vec4 border;
...
layout(location = 5) out vec2 v_params;
layout(location = 6) out vec4 v_border;
