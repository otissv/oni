...
INTER_FONT_FIXTURE :: "assets/fonts/Inter-VariableFont_opsz,wght.ttf"
INTER_ITALIC_FONT_FIXTURE :: "assets/fonts/Inter-Italic-VariableFont_opsz,wght.ttf"
PIXEL_FONT_FIXTURE :: "assets/fonts/PixelOperator8.ttf"
...
font_make_shaped_line_applies_letter_spacing_between_glyphs :: proc(t: ^testing.T) {
	glyphs := []Shaped_Glyph{{glyph_id = 1, x_advance = 10}, {glyph_id = 2, x_advance = 12}, {glyph_id = 3, x_advance = 8}}
