...
*/
Table_Heading_Config :: o.Widget_Config

/*
Table widget per-frame frame_state merged with its fully resolved style config.
*/
Table_Heading_State :: o.Widget_Merged_State(o.Widget_Frame_State, o.Resolved_Widget_Config)

/*
Table widget event snapshot with frame_state and optional input metadata.
*/
Table_Heading_Event :: o.Widget_Event(Table_Heading_State)
...
Table_Heading_Props :: struct {
	...
	on_mount:                     proc(frame_state: Table_Heading_State) -> o.Mount,
...
Table_Heading :: proc(props: Table_Heading_Props) {
	...
	event, _ = widget_refresh_merged_if_interaction_changed(props, &frame_state, table_heading_theme_base, style_fp)
	config = frame_state.config
