...
*/
Table_Body_Config :: oni.Widget_Config

/*
Table widget per-frame frame_state merged with its fully resolved style config.
*/
Table_Body_State :: oni.Widget_Merged_State(oni.Widget_Frame_State, oni.Resolved_Widget_Config)

/*
Table widget event snapshot with frame_state and optional input metadata.
*/
Table_Body_Event :: oni.Widget_Event(Table_Body_State)
...
Table_Body_Props :: struct {
	...
	on_mount:                     proc(frame_state: Table_Body_State) -> oni.Mount,
	on_unmount:                   proc(frame_state: Table_Body_State) -> oni.Mount,
