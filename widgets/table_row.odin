...
*/
Table_Row_Config :: o.Widget_Config

/*
Table widget per-frame frame_state merged with its fully resolved style config.
*/
Table_Row_State :: o.Widget_Merged_State(o.Widget_Frame_State, o.Resolved_Widget_Config)

/*
Table widget event snapshot with frame_state and optional input metadata.
*/
Table_Row_Event :: o.Widget_Event(Table_Row_State)


/*
Table widget props: config overrides, child callback, and input event handlers.
*/
Table_Row_Props :: struct {
	config:                       Table_Row_Config,
	child:                        proc(frame_state: Table_Row_State),
	unmount:                      bool,
	can_interactive_during_mount: bool,
	on_mount:                     proc(frame_state: Table_Row_State) -> o.Mount,
	on_unmount:                   proc(frame_state: Table_Row_State) -> o.Mount,
	on_focus:                     proc(event: Table_Row_Event),
	on_blur:                      proc(event: Table_Row_Event),
	on_mouse_enter:               proc(event: Table_Row_Event),
	on_mouse_leave:               proc(event: Table_Row_Event),
	on_mouse_pressed:             proc(event: Table_Row_Event),
	on_mouse_down:                proc(event: Table_Row_Event),
	on_mouse_released:            proc(event: Table_Row_Event),
	on_mouse_move:                proc(event: Table_Row_Event),
	on_click:                     proc(event: Table_Row_Event),
	on_contextmenu:               proc(event: Table_Row_Event),
	on_key_pressed:               proc(event: Table_Row_Event),
	on_key_down:                  proc(event: Table_Row_Event),
	on_key_released:              proc(event: Table_Row_Event),
}
...
*/
@(private)
table_row_theme_base :: proc(frame_state: ^Table_Row_State) -> Table_Row_Config {
...
*/
Table_Row :: proc(props: Table_Row_Props) {
	cfg := props.config
	...
	table_widget_draw_chrome(layout_id, .TABLE_ROW, rect, config, &frame_state, event)
